...
public class DatePicker_ForMonth extends LinearLayout implements YearPicker.OnYearSelectedListener,
     ...
     */
    public DatePicker_ForMonth(Context context) {
        this(context, null);
    }
     ...
     */
    public DatePicker_ForMonth(Context context, @Nullable AttributeSet attrs) {
     ...
     */
    public DatePicker_ForMonth(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        LayoutInflater.from(context).inflate(R.layout.datepicker_month, this);
        initChild();
    ...
    private void initChild() {
        mYearPicker = findViewById(R.id.yearPicker2);
        mYearPicker.setOnYearSelectedListener(this);
        mMonthPicker = findViewById(R.id.monthPicker2);
        mMonthPicker.setOnMonthSelectedListener(this);
        mDayPicker = findViewById(R.id.dayPicker2);
