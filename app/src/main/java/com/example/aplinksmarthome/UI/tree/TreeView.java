...
import static com.example.aplinksmarthome.UI.tree.DensityUtils.dp2px;
...
//        path.quadTo(toX - dp2px(mContext, 15), toY, toX, toY);
    ...
    public int returnlayer_int(NodeModel<String> model){
        NodeView treeNodeView = (NodeView) findNodeViewFromNodeModel(model);
        int layer;
        layer = treeNodeView.getLayer();
        return layer;
    }
    public int return_this_layer_id_int(NodeModel<String> model){
        NodeView treeNodeView = (NodeView) findNodeViewFromNodeModel(model);
        int this_layer_id;
        this_layer_id = treeNodeView.getLayer();
